...
import time
import math
import pokerHandDetectorFunction as pFunction
...
while True:
    ...
    for r in results:
        ...
        print(hand)
        if len(hand)==5:
            results=pFunction.findPokerHand(hand)
            print(results)
            cvzone.putTextRect(img,f'Your Hand: {results}',(400,75),scale=3,thickness=5)
